...
TRANSITIONS = {
    ...
    "un_FB": S(
        ...
        pv=I([0.45, 0.45, 0.18], 0.22, 0.030, [0.20, 0.20, 0.05], [0.78, 0.78, 0.36]),
    ),
    "un_novel_FF": S(
        0.045,
    ...
    "FF_FB_broad": S(
        ...
        pv=I([0.34, 0.34, 0.14], 0.22, 0.028, [0.14, 0.14, 0.0], [0.66, 0.66, 0.30]),
    ),
    "FF_FB_broad_weak": S(
        0.055,
    ...
    "FB_FB": S(
        ...
        pv=I([0.30, 0.30, 0.24], 0.28, 0.040, hi=0.66),
    ),
    "fb_fb_weak": S(
        0.022,
    ...
    "O_un": S(
        ...
        ff=I([0.01, 0.01, 0.005], 0.40, 0.006, hi=0.03),
        ...
        pv=I([0.42, 0.42, 0.18], 0.20, 0.030, [0.20, 0.20, 0.05], [0.74, 0.74, 0.40]),
    ),
}
